...
parser.add_argument('--resume_from_checkpoint', type=bool, required=False, help='Path to checkpoint to resume from')
...
def main():
    ...
    trainer.train(batch_size=128, resume_from_checkpoint=args.resume_from_checkpoint)
