...
class InferencePipeline:
    ...
    def run_inference(self, inputs: List, max_new_tokens: int = 128):
        """
        Runs inference on the inputs

        Returns:
            List of content generated by the LLM (one per input)
        """
        pass

class ModelInferencePipeline(InferencePipeline):
    """
...
class DatasetInferencePipeline(InferencePipeline):
    """
